...
function FontPicker({ label, value, onChange, open, setOpen, preview }: {
  ...
  return <>
    <label>{label}</label>
    <div className={`fontDropdown ${open ? 'isOpen' : ''}`}>
      ...
      <section className="pdfSheet pdfSheetFacade">
        ...
        <div className="pdfFacadeCenter">
          <div className="pdfFacadeStage snapshotStage">
            {stageShot
              ? <div className="stageSnapshotBox" style={{ width: `${stageShotFit.width}px`, height: `${stageShotFit.height}px` }}>
                  <img src={stageShot} className="stageSnapshot"/>
                  <div className="pdfWatermark">REKLAMASTROY.RU</div>
                </div>
              : (facade ? <div className="stageSnapshotBox" style={{ width: `${pdfFacadeBox.width}px`, height: `${pdfFacadeBox.height}px` }}><img src={facade} className="facade"/><div className="pdfWatermark">REKLAMASTROY.RU</div></div> : <div className="placeholder">Фото фасада не загружено</div>)}
          </div>
        </div>
