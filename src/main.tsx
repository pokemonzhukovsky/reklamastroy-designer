    ...
    {downloadGateOpen && createPortal(
      <div className="leadGateOverlay" role="dialog" aria-modal="true" aria-labelledby="lead-gate-title" onMouseDown={(e) => {
        ...
        <div className="leadGateModal">
          <button type="button" className="leadGateClose" aria-label="Закрыть" disabled={leadSending} onClick={() => setDownloadGateOpen(false)}>×</button>
          <div className="leadGateBadge">Файл почти готов</div>
