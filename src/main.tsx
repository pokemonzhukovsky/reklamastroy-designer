...
function ColorDropdown({ label, palette, list, value, onChange }: {
  ...
  return <div className="colorDropdown" ref={wrapRef}>
    ...
    <button type="button" className={`colorCurrent ${open ? 'open' : ''}`} onClick={() => setOpen(v => !v)}>
      <span className="colorCurrentMain">
      ...
      <span className="colorPaletteTag">{palette}</span>
    </button>
    ...
    <div className="pdfPages" ref={pdfRef}>
      <section className="pdfSheet pdfSheetFacade">
        <header className="pdfTopHeader pdfTopHeaderFinal">
          ...
          <div className="pdfHeaderCard">
            <i className="pdfHeaderIcon">✓</i>
            <div className="pdfHeaderText">
              <span>Гарантия</span>
              <b>3 года</b>
            </div>
          </div>
          ...
          <div className="pdfHeaderCard">
            <i className="pdfHeaderIcon">12</i>
            <div className="pdfHeaderText">
              <span>Опыт</span>
              <b>12 лет</b>
            </div>
          ...
          <div className="pdfHeaderCard wide">
            <i className="pdfHeaderIcon">★</i>
            <div className="pdfHeaderText">
          ...
          <div className="pdfHeaderContacts">
            <div><em>web</em><span>reklamastroy.ru</span></div>
            <div><em>mail</em><span>sales@reklamastroy.ru</span></div>
          </div>

          <div className="pdfHeaderPhones">
            <div><em>495</em><span>+7 495 008 37 95</span></div>
            <div><em>925</em><span>+7 925 888 37 95</span></div>
          </div>
        </header>
