...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${w}mm" height="${h}mm" viewBox="0 0 ${w} ${h}" version="1.1">
  ...
  const pdf = async () => {
    ...
    // v3.74 — первая страница PDF снова содержит только дневную визуализацию без подписи режима.
    ...
    for (let i = 0; i < pages.length; i++) {
      ...
      if (i === 0 && pdfStageMm && shotDay) {
        ...
        doc.addImage(shotDay, 'PNG', drawX, drawY, drawW, drawH, undefined, 'FAST');
