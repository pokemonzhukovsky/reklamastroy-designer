...
// Временный режим до подключения формы Тильды/amoCRM.
// true: если мост Тильды не отвечает, после проверки имени и телефона файл всё равно скачивается.
// После подключения формы можно переключить на false для строгой блокировки до подтверждения от Тильды.
const ALLOW_DOWNLOAD_WITHOUT_TILDA_BRIDGE = true;

type DownloadKind = 'pdf' | 'svg';
...
const FONTS: FontItem[] = [
  ...
  { name: 'Anton', family: 'Anton, Impact, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Узкие жирные' },
  { name: 'Roboto Condensed ExtraBold', family: '__RobotoCondensed800__', sample: 'ВЫВЕСКА 123', group: 'Узкие жирные' },
  { name: 'Roboto Condensed Black', family: '__RobotoCondensed900__', sample: 'ВЫВЕСКА 123', group: 'Узкие жирные' },
  ...
  { name: 'Alumni Sans', family: 'Alumni Sans, Arial Narrow, sans-serif', sample: 'Вывеска 123', group: 'Узкие' },
  { name: 'Fira Sans Extra Condensed', family: 'Fira Sans Extra Condensed, Arial Narrow, sans-serif', sample: 'Вывеска 123', group: 'Узкие' },
  { name: 'Yanone Kaffeesatz', family: 'Yanone Kaffeesatz, Arial Narrow, sans-serif', sample: 'Вывеска 123', group: 'Узкие' },
  { name: 'Amatic SC', family: 'Amatic SC, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Bad Script', family: 'Bad Script, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Caveat', family: 'Caveat, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Marck Script', family: 'Marck Script, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Neucha', family: 'Neucha, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Pangolin', family: 'Pangolin, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Pacifico', family: 'Pacifico, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Lobster', family: 'Lobster, cursive', sample: 'Вывеска 123', group: 'Акцидентные' },
  { name: 'Rubik Mono One', family: 'Rubik Mono One, Arial Black, sans-serif', sample: 'Вывеска 123', group: 'Акцидентные' },
  { name: 'Kelly Slab', family: 'Kelly Slab, Arial, sans-serif', sample: 'Вывеска 123', group: 'Акцидентные' },
  { name: 'Kurale', family: 'Kurale, Georgia, serif', sample: 'Вывеска 123', group: 'Акцидентные' },
  { name: 'Tenor Sans', family: 'Tenor Sans, Arial, sans-serif', sample: 'Вывеска 123', group: 'Тонкие' },
  { name: 'Montserrat Alternates', family: 'Montserrat Alternates, Arial, sans-serif', sample: 'Вывеска 123', group: 'Геометрические' },
  { name: 'Balsamiq Sans', family: 'Balsamiq Sans, Arial, sans-serif', sample: 'Вывеска 123', group: 'Скруглённые' },
  { name: 'Brygada 1918', family: 'Brygada 1918, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Vollkorn', family: 'Vollkorn, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Viaoda Libre', family: 'Viaoda Libre, Georgia, serif', sample: 'Вывеска 123', group: 'Акцидентные' },
  { name: 'Alice', family: 'Alice, Georgia, serif', sample: 'Вывеска 123', group: 'Декоративные' },
  { name: 'Andika', family: 'Andika, Arial, sans-serif', sample: 'Вывеска 123', group: 'Гуманистические' },
  { name: 'Bellota', family: 'Bellota, Arial, sans-serif', sample: 'Вывеска 123', group: 'Скруглённые' },
  { name: 'Cormorant Infant', family: 'Cormorant Infant, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Cormorant SC', family: 'Cormorant SC, Georgia, serif', sample: 'ВЫВЕСКА 123', group: 'Антиква' },
  { name: 'Cormorant Unicase', family: 'Cormorant Unicase, Georgia, serif', sample: 'Вывеска 123', group: 'Акцидентные' },
  { name: 'Dela Gothic One', family: 'Dela Gothic One, Arial Black, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Жирные' },
  { name: 'Istok Web', family: 'Istok Web, Arial, sans-serif', sample: 'Вывеска 123', group: 'Универсальные' },
  { name: 'Ledger', family: 'Ledger, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Lobster Two', family: 'Lobster Two, cursive', sample: 'Вывеска 123', group: 'Рукописные' },
  { name: 'Noto Sans Display', family: 'Noto Sans Display, Arial, sans-serif', sample: 'Вывеска 123', group: 'Универсальные' },
  { name: 'Noto Serif Display', family: 'Noto Serif Display, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Nunito', family: 'Nunito, Arial, sans-serif', sample: 'Вывеска 123', group: 'Скруглённые' },
  { name: 'Playfair Display SC', family: 'Playfair Display SC, Georgia, serif', sample: 'ВЫВЕСКА 123', group: 'Антиква' },
  { name: 'Podkova', family: 'Podkova, Georgia, serif', sample: 'Вывеска 123', group: 'Брусковые' },
  { name: 'Prosto One', family: 'Prosto One, Arial Black, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Акцидентные' },
  { name: 'Roboto Flex', family: 'Roboto Flex, Arial, sans-serif', sample: 'Вывеска 123', group: 'Современные' },
  { name: 'Roboto Serif', family: 'Roboto Serif, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Ruslan Display', family: 'Ruslan Display, Arial Black, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Декоративные' },
  { name: 'Seymour One', family: 'Seymour One, Arial Black, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Жирные' },
  { name: 'Sofia Sans Condensed', family: 'Sofia Sans Condensed, Arial Narrow, sans-serif', sample: 'Вывеска 123', group: 'Узкие' },
  { name: 'Sofia Sans Extra Condensed', family: 'Sofia Sans Extra Condensed, Arial Narrow, sans-serif', sample: 'Вывеска 123', group: 'Очень узкие' },
  { name: 'Ubuntu Condensed', family: 'Ubuntu Condensed, Arial Narrow, sans-serif', sample: 'Вывеска 123', group: 'Узкие' },
  { name: 'Alegreya SC', family: 'Alegreya SC, Georgia, serif', sample: 'ВЫВЕСКА 123', group: 'Антиква' },
  { name: 'PT Serif Caption', family: 'PT Serif Caption, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Spectral', family: 'Spectral, Georgia, serif', sample: 'Вывеска 123', group: 'Антиква' },
  { name: 'Spectral SC', family: 'Spectral SC, Georgia, serif', sample: 'ВЫВЕСКА 123', group: 'Антиква' },
  { name: 'Merriweather Sans', family: 'Merriweather Sans, Arial, sans-serif', sample: 'Вывеска 123', group: 'Универсальные' },
  { name: 'Fira Sans Condensed', family: 'Fira Sans Condensed, Arial Narrow, sans-serif', sample: 'Вывеска 123', group: 'Узкие' },
  { name: 'Fira Sans ExtraBold', family: 'Fira Sans, Arial, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Жирные' },
  { name: 'Roboto Slab ExtraBold', family: 'Roboto Slab, Georgia, serif', sample: 'ВЫВЕСКА 123', group: 'Брусковые' },
  { name: 'Montserrat ExtraBold', family: 'Montserrat, Arial, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Жирные' },
  { name: 'Manrope ExtraBold', family: 'Manrope, Arial, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Жирные' },
  { name: 'Unbounded Black', family: 'Unbounded, Arial Black, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Жирные' },
  { name: 'Exo 2 Black', family: 'Exo 2, Arial Black, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Технологичные' },
  { name: 'Tektur Black', family: 'Tektur, Arial Black, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Технологичные' },
  { name: 'Jura Bold', family: 'Jura, Arial, sans-serif', sample: 'ВЫВЕСКА 123', group: 'Технологичные' },
  { name: 'Poiret One Light', family: 'Poiret One, Arial, sans-serif', sample: 'Вывеска 123', group: 'Тонкие' },
  { name: 'Forum Display', family: 'Forum, Georgia, serif', sample: 'Вывеска 123', group: 'Тонкие' },
  { name: 'Oranienbaum Display', family: 'Oranienbaum, Georgia, serif', sample: 'Вывеска 123', group: 'Тонкие' },
];
...
function fontCssFamily(value: string) {
  if (value === '__RobotoCondensed800__' || value === '__RobotoCondensed900__') {
    return "'Roboto Condensed', 'Arial Narrow', sans-serif";
  }
  return value;
}

function fontCssWeight(value: string) {
  if (value === '__RobotoCondensed800__') return 800;
  if (value === '__RobotoCondensed900__') return 900;
  if (value.startsWith('Anton')) return 400;
  return 900;
}
...
function FontPicker({ label, value, onChange, open, setOpen, preview }: {
  ...
  const filteredFonts = FONTS.filter(f => `${f.name} ${f.group}`.toLowerCase().includes(fontSearch.trim().toLowerCase()));
  ...
  const menu = open && typeof document !== 'undefined' ? createPortal(
    <div ref={menuRef} className="fontMenu fontMenuPortal" style={{ left: `${menuPos.left}px`, top: `${menuPos.top}px`, width: `${menuPos.width}px`, maxHeight: `${menuPos.maxHeight}px` }}>
      <div className="fontSearchWrap">
        <input value={fontSearch} onChange={e => setFontSearch(e.target.value)} placeholder="Найти шрифт или категорию" autoFocus />
        <small>Доступно шрифтов: {filteredFonts.length} из {FONTS.length}</small>
      </div>
      {filteredFonts.map(f => <button type="button" key={f.name} className={value === f.family ? 'selected' : ''} onClick={() => { onChange(f.family); setOpen(false); setFontSearch(''); }}>
        <span><b>{f.name}</b><small>{f.group}</small></span>
        <em style={{ fontFamily: fontCssFamily(f.family), fontWeight: fontCssWeight(f.family) }}>{f.sample}</em>
      </button>)}
    </div>,
    document.body
  ) : null;
  ...
  return <>
    ...
    <div ref={wrapRef} className={`fontDropdown ${open ? 'isOpen' : ''}`}>
      <button ref={buttonRef} className="fontCurrent" type="button" onClick={() => setOpen(v => !v)}>
        ...
        <span className="fontPreview" style={{ fontFamily: fontCssFamily(value), fontWeight: fontCssWeight(value) }}>{preview || 'Вывеска'}</span>
      </button>
      {menu}
    </div>
  </>;
...
function App() {
  ...
  const [curve1, setCurve1] = useState(defaultState.curve1);
  const [curve2, setCurve2] = useState(defaultState.curve2);
  const [followCurve1, setFollowCurve1] = useState(defaultState.followCurve1);
  const [followCurve2, setFollowCurve2] = useState(defaultState.followCurve2);
  ...
  const [stageShotDay, setStageShotDay] = useState('');
  const [stageShotNight, setStageShotNight] = useState('');
  ...
  // Mobile/Tilda iframe: сообщаем родительской странице фактическую высоту конструктора,
  // чтобы iframe не обрезался и не создавал двойную прокрутку на телефонах.
  useEffect(() => {
    const sendHeight = () => {
      ...
      try {
        window.parent?.postMessage({
          type: 'REKLAMASTROY_CONSTRUCTOR_HEIGHT',
          height
        }, '*');
      } catch {}
    };
  ...
  useEffect(() => {
    const onMessage = (event: MessageEvent) => {
      ...
      if (!data || data.type !== 'REKLAMASTROY_CONSTRUCTOR_LEAD_RESULT') return;
      if (!leadRequestIdRef.current || data.requestId !== leadRequestIdRef.current) return;
      ...
      if (data.success) {
        ...
        window.setTimeout(() => {
          if (kind === 'pdf') void pdf();
          if (kind === 'svg') downloadVectorSvg();
        }, 80);
      } else {
        setLeadError(data.message || 'Не удалось отправить заявку. Попробуйте ещё раз.');
      }
    };
  ...
  // Калибровочный размер применяем только после завершения ввода.
  // Иначе при удалении значения 1200 браузер успевает пересчитать масштаб
  // для промежуточных значений 120, 12 и 1 мм, что создаёт гигантские
  // элементы и может привести к белому экрану.
  const commitCalibrationInput = () => {
    ...
    if (Number.isFinite(next) && next > 0) {
      setCalibrationCm(next);
      setCalibrationInput(String(next));
      return;
    }

    // При ошибочном значении возвращаем последнее корректное число.
    setCalibrationInput(calibrationCm > 0 ? String(calibrationCm) : '');
  };
  ...
  useEffect(() => {
    ...
    if (!fontsApi) return;
    Promise.all([
      fontsApi.load(`${fontCssWeight(font)} 100px ${fontCssFamily(font)}`),
      fontsApi.load(`${fontCssWeight(line2Font)} 100px ${fontCssFamily(line2Font)}`),
      fontsApi.ready
    ]).then(() => {
  ...
  useEffect(() => {
    ...
    const mouseMove = (e: MouseEvent) => applyDrag(e.clientX, e.clientY);
  ...
  const pxPerCm = points.length === 2 && Number.isFinite(calibrationCm) && calibrationCm > 0 ? distance(points[0], points[1]) / calibrationCm : 0;
  ...
  const getGlyphMetrics = (text: string, fontSizePx: number, fontFamily = font) => {
    ...
    // Важно: пробел — полноценный символ с собственной шириной. Раньше проверка через
    // text.trim() превращала одиночный пробел в слово «Вывеска», поэтому между двумя
    // словами появлялся огромный разрыв и вся композиция уезжала. Фолбэк нужен только
    // для действительно пустой строки, но не для пробелов внутри текста.
    const sample = text && text.length > 0 ? text : 'Вывеска';
    if (typeof document === 'undefined') {
      const fallbackWidth = sample === ' ' ? fontSizePx * 0.28 : Math.max(1, [...sample].length) * fontSizePx * 0.62;
    ...
    ctx.font = `${fontCssWeight(fontFamily)} ${fontSizePx}px ${fontCssFamily(fontFamily)}`;
    ...
    const glyphCount = Math.max(0, [...sample].length - 1);
    const letterSpacing = fontSizePx * 0.01;
    const spacingWidth = glyphCount * letterSpacing;
    // У пробела actualBoundingBoxLeft/Right обычно равны нулю, но advance width есть.
    // Поэтому обязательно учитываем metrics.width, иначе пробел снова схлопнется или
    // будет рассчитан не так, как в реальном шрифте.
    const visualWidth = Math.max(1, Math.max(left + right, metrics.width) + spacingWidth);
    return {
  ...
  const measureFirstGlyphVisibleInset = (textValue: string, fontSizePx: number, fontFamily = font) => {
    void fontMeasureTick;
    const firstGlyph = [...(textValue || '')].find(char => char !== ' ') || ([...(textValue || '')][0] || 'В');
    if (typeof document === 'undefined') return 0;
    const canvas = document.createElement('canvas');
    const pad = Math.max(12, Math.ceil(fontSizePx * 0.45));
    canvas.width = Math.max(64, Math.ceil(fontSizePx * 3 + pad * 2));
    canvas.height = Math.max(64, Math.ceil(fontSizePx * 2.4 + pad * 2));
    ...
    const ascent = Math.max(1, metrics.actualBoundingBoxAscent || fontSizePx * 0.72);
    const strokeBase = Math.max(0.7, fontSizePx * 0.014);
    const baselineX = pad;
    const baselineY = pad + ascent;
    ctx.strokeStyle = '#000';
    ctx.fillStyle = '#000';
    ctx.lineWidth = strokeBase;
    ctx.strokeText(firstGlyph, baselineX, baselineY);
    ctx.fillText(firstGlyph, baselineX, baselineY);
    const data = ctx.getImageData(0, 0, canvas.width, canvas.height).data;
    for (let x = 0; x < canvas.width; x += 1) {
      for (let y = 0; y < canvas.height; y += 1) {
        if (data[(y * canvas.width + x) * 4 + 3] > 8) {
          return Math.max(0, x - pad);
        }
      }
    }
    return 0;
  ...
  const curveAmounts = twoLines ? [curve1, curve2] : [curve1];
  const followCurveFlags = twoLines ? [followCurve1, followCurve2] : [followCurve1];

  type CurvedGlyph = { char: string; x: number; width: number; yOffset: number; rotation: number };
  type CurvedLineLayout = { glyphs: CurvedGlyph[]; width: number; minY: number; maxY: number; height: number; sagitta: number };

  const createCurvedLineLayout = (text: string, fontSizePx: number, fontFamily: string, targetHeightPx: number, curveAmount: number, followCurve: boolean): CurvedLineLayout => {
    const chars = [...(text || ' ')];
    const spacing = fontSizePx * 0.01;
    const widths = chars.map(char => Math.max(1, getGlyphMetrics(char, fontSizePx, fontFamily).width));
    const width = Math.max(1, widths.reduce((sum, value) => sum + value, 0) + Math.max(0, chars.length - 1) * spacing);
    const maxSagitta = Math.min(width * 0.28, targetHeightPx * 2.5);
    const sagitta = (Math.max(-100, Math.min(100, curveAmount)) / 100) * maxSagitta;
    let cursor = 0;
    const glyphs = chars.map((char, index) => {
      const glyphWidth = widths[index];
      const x = cursor + glyphWidth / 2;
      cursor += glyphWidth + (index < chars.length - 1 ? spacing : 0);
      const u = width > 0 ? (x / width) * 2 - 1 : 0;
      // +100 = дуга вверх, -100 = дуга вниз.
      const yOffset = -sagitta * (1 - u * u);
      const slope = width > 0 ? (4 * sagitta * u / width) : 0;
      const rotation = followCurve ? Math.atan(slope) * 180 / Math.PI : 0;
      return { char, x, width: glyphWidth, yOffset, rotation };
    });
    const minY = Math.min(0, ...glyphs.map(g => g.yOffset));
    const maxY = Math.max(0, ...glyphs.map(g => g.yOffset));
    return { glyphs, width, minY, maxY, height: Math.max(1, targetHeightPx + maxY - minY), sagitta };
  };

  const curvedLineLayouts = lines.map((line, i) => createCurvedLineLayout(
    line,
    lineFontSizesPx[i],
    lineFonts[i] || font,
    lineTargetHeightsPx[i],
    curveAmounts[i] || 0,
    followCurveFlags[i] ?? true
  ));

  // Строки и их габариты теперь рассчитываются одной геометрией — той же, по которой
  // рисуются прямые и изогнутые буквы в рабочем окне, PDF и SVG.
  const textLineWidthsPx = curvedLineLayouts.map(layout => layout.width);
  ...
  // Строгое выравнивание второй строки делаем не только по контейнеру строки,
  // но и по реальному видимому старту первой буквы. Иначе у разных шрифтов
  // вторая строка визуально уезжает влево/вправо из-за отличающихся боковых полей глифа.
  const strictLeftAnchorPx = Math.max(0, ...lineBaseStartOffsetsPx);
  const lineFirstGlyphInsetsPx = lines.map((line, i) => measureFirstGlyphVisibleInset(line, lineFontSizesPx[i], lineFonts[i] || font));
  const referenceFirstGlyphInsetPx = lineFirstGlyphInsetsPx[0] || 0;
  const lineStrictLeftOffsetsPx = lines.map((_, i) => Math.max(0, strictLeftAnchorPx + referenceFirstGlyphInsetPx - (lineFirstGlyphInsetsPx[i] || 0)));
  const textWidthPx = Math.max(1, ...textLineWidthsPx.map((width, i) => width + (line2Align === 'left' ? (lineStrictLeftOffsetsPx[i] || 0) : (lineBaseStartOffsetsPx[i] || 0))));
  const textLineOffsetsPx = lines.map((_, i) => {
    const currentWidth = textLineWidthsPx[i] || 0;
    const baseOffset = line2Align === 'left' ? (lineStrictLeftOffsetsPx[i] || 0) : (lineBaseStartOffsetsPx[i] || 0);
  ...
  const textHeightPx = curvedLineLayouts.reduce((sum, layout) => sum + layout.height, 0) + (twoLines ? lineGapPx : 0);
  const textHeightCm = textHeightPx / workingPxPerCm;
  ...
  const startSignTouch = (e: React.TouchEvent<HTMLDivElement>) => {
    if (!stageRef.current || !e.touches.length) return;
    e.stopPropagation();
    const t = e.touches[0];
    const p = getStagePoint(t.clientX, t.clientY);
    setDrag({ type: 'sign', dx: p.x - signPos.x, dy: p.y - signPos.y });
  };
  const startPointTouch = (e: React.TouchEvent<HTMLDivElement>, index: number) => {
  ...
  const downloadVectorSvg = () => {
    ...
    let accumulatedLineTopMm = textTopYmm;
    const textNodes = lines.map((line, i) => {
      const layout = curvedLineLayouts[i];
      const x = textStartXmm + (textLineOffsetsMm[i] || 0);
      const y = accumulatedLineTopMm;
      accumulatedLineTopMm += toMm(layout?.height || lineTargetHeightsPx[i]) + (i === 0 && twoLines ? effectiveLineGapCm : 0);
      const fontMm = fontSizesMm[i] || lineHeightsCm[i] || line1HeightCm;
      const strokeMm = Math.max(0.55, fontMm * 0.014);
      const familyValue = lineFonts[i] || font;
      const family = escapeXml(fontCssFamily(familyValue));
      const weight = fontCssWeight(familyValue);
      const fill = lineFaces[i] || face;
      const stroke = lineSides[i] || side;
      const glyphNodes = (layout?.glyphs || []).map((glyph, glyphIndex) => {
        const gx = x + toMm(glyph.x - glyph.width / 2);
        const gy = y + toMm(glyph.yOffset - (layout?.minY || 0));
        const centerX = gx + toMm(glyph.width / 2);
        const centerY = gy + lineHeightsCm[i] / 2;
        const value = escapeXml(glyph.char === ' ' ? '\u00a0' : glyph.char);
        const transform = Math.abs(glyph.rotation) > 0.001 ? ` transform="rotate(${fmt(glyph.rotation)} ${fmt(centerX)} ${fmt(centerY)})"` : '';
        return `
        <g id="glyph-${i + 1}-${glyphIndex + 1}"${transform}>
          <text x="${fmt(gx + sideDepthMm)}" y="${fmt(gy + sideDepthMm)}" fill="${stroke}" stroke="${stroke}" stroke-width="${fmt(strokeMm)}" paint-order="stroke fill">${value}</text>
          <text x="${fmt(gx)}" y="${fmt(gy)}" fill="${fill}" stroke="${stroke}" stroke-width="${fmt(strokeMm)}" paint-order="stroke fill">${value}</text>
        </g>`;
      }).join('');
      return `
    <g id="text-line-${i + 1}" font-family="${family}" font-size="${fmt(fontMm)}" font-weight="${weight}" dominant-baseline="hanging">${glyphNodes}
    </g>`;
    }).join('');
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="${w}mm" height="${h}mm" viewBox="0 0 ${w} ${h}" version="1.1">
  ...
  const pdf = async () => {
    ...
    // v3.75 — быстрый и компактный PDF: дневная визуализация с оптимизированным JPEG,
    // техническая страница остаётся PNG для чётких размеров и увеличенного макета.
    // Положение, масштаб и поворот вывески фиксируются до технического рендера второй страницы.
    const restoreNightAfterExport = night;
    const stageEl = stageRef.current;
    const exportScale = Math.max(2.6, Math.min(3.4, (window.devicePixelRatio || 1) * 1.8));

    const captureStageMode = async (nightMode: boolean) => {
      flushSync(() => setNight(nightMode));
      ...
      return {
        shot: exportCanvas.toDataURL('image/jpeg', 0.9),
        ratio: exportCanvas.width && exportCanvas.height ? exportCanvas.width / exportCanvas.height : 16 / 9
      };
    };

    // Фиксируем только дневную визуализацию. Геометрию текста не пересчитываем до снимка.
    const dayCapture = await captureStageMode(false);
    const shotDay = dayCapture.shot;
    const ratio = dayCapture.ratio;

    // Возвращаем интерфейс пользователя в исходный режим сразу после получения снимка.
    flushSync(() => setNight(restoreNightAfterExport));
    await new Promise(requestAnimationFrame);
    // Только ПОСЛЕ фиксации первой страницы разрешаем дождаться активных шрифтов для
    // технического макета второй страницы. Важно: здесь больше нет принудительного
    // setFontMeasureTick(), чтобы сам экспорт не менял положение живой вывески.
    const fontsApi = (document as any).fonts;
    if (fontsApi) {
      const activeFonts = Array.from(new Set(
        [font, ...(twoLines ? [line2Font] : [])].filter(Boolean)
      ));
      await Promise.all(activeFonts.map((family) =>
        fontsApi.load(`${fontCssWeight(family)} 160px ${fontCssFamily(family)}`).catch(() => undefined)
      ));
      await fontsApi.ready.catch(() => undefined);
    }
    ...
    flushSync(() => {
      ...
      setStageShotDay(shotDay);
      setStageShotNight('');
      setPdfSignShot(signShot);
    });

    // Ждём, пока снимок реально загрузится в скрытом PDF-шаблоне.
    const snapshotImgs = Array.from(pdfRef.current.querySelectorAll('.stageSnapshot')) as HTMLImageElement[];
    await Promise.all(snapshotImgs.map(async (snapshotImg) => {
      ...
      if (snapshotImg.decode) await snapshotImg.decode().catch(() => undefined);
    }));
    ...
    for (let i = 0; i < pages.length; i++) {
      ...
      const isFacadePage = i === 0;
      const img = isFacadePage
        ? canvas.toDataURL('image/jpeg', 0.88)
        : canvas.toDataURL('image/png');
      if (i > 0) doc.addPage('a4', 'landscape');
      doc.addImage(img, isFacadePage ? 'JPEG' : 'PNG', 0, 0, 297, 210, undefined, 'FAST');
      ...
      if (i === 0 && pdfStageMm && shotDay) {
        const imageBoxH = pdfStageMm.h;
        const shotRatio = ratio || 16 / 9;
        const boxRatio = pdfStageMm.w / imageBoxH;
        ...
        if (shotRatio >= boxRatio) {
          ...
          drawY = pdfStageMm.y + (imageBoxH - drawH) / 2;
        } else {
          drawH = imageBoxH;
          drawW = imageBoxH * shotRatio;
          drawX = pdfStageMm.x + (pdfStageMm.w - drawW) / 2;
        }

        doc.setFillColor(255, 255, 255);
        doc.rect(pdfStageMm.x, pdfStageMm.y, pdfStageMm.w, pdfStageMm.h, 'F');
        doc.addImage(shotDay, 'JPEG', drawX, drawY, drawW, drawH, undefined, 'FAST');
  ...
  const requestDownload = (kind: DownloadKind) => {
    if (leadUnlocked) {
      if (kind === 'pdf') void pdf();
      if (kind === 'svg') downloadVectorSvg();
      return;
  ...
  const submitLeadForDownload = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    ...
    if (!name) {
      setLeadError('Введите ваше имя.');
      return;
    }
    if (phoneDigits.length < 10) {
      setLeadError('Введите корректный телефон для связи.');
      return;
    }
    if (!pendingDownload) return;

    const requestId = `rs-${Date.now()}-${Math.random().toString(36).slice(2, 9)}`;
    leadRequestIdRef.current = requestId;
    setLeadSending(true);
    setLeadError('');

    const payload = {
      type: 'REKLAMASTROY_CONSTRUCTOR_LEAD',
      requestId,
      payload: {
        name,
        phone,
        downloadType: pendingDownload.toUpperCase(),
        source: 'Конструктор вывески',
    ...
    try {
      ...
      // Не оставляем форму в бесконечной загрузке, если мост Тильды ещё не подключён
      // или временно не отвечает. В тестовом режиме разрешаем скачивание после
      // корректного заполнения имени и телефона.
      window.setTimeout(() => {
        if (leadRequestIdRef.current !== requestId) return;

        setLeadSending(false);
        if (ALLOW_DOWNLOAD_WITHOUT_TILDA_BRIDGE) {
          setLeadUnlocked(true);
          setDownloadGateOpen(false);
          setLeadError('');
          const kind = pendingDownload;
          ...
          setLeadError('Не получено подтверждение от формы Тильды. Проверьте подключение формы и повторите попытку.');
        }
      }, 1800);
    } catch {
      setLeadSending(false);
      if (ALLOW_DOWNLOAD_WITHOUT_TILDA_BRIDGE) {
        ...
        setLeadError('Не удалось передать заявку на сайт. Обновите страницу и попробуйте снова.');
      }
    }
  };

  const drawingScale = Math.min(1.32, 1040 / Math.max(1, visualSignWidthPx + 430), 520 / Math.max(1, visualSignHeightPx + 520));

  const pdfFacadeBox = { width: 930, height: 524 };
  ...
  const SignGraphic = ({ pdfMode = false, scale = 1, drawingMode = false, snapshotSrc = '' }: { pdfMode?: boolean; scale?: number; drawingMode?: boolean; snapshotSrc?: string }) => {
    ...
    const lineHeightsScaled = curvedLineLayouts.map(layout => layout.height * scale);
    ...
    // На 2-й странице PDF текст больше не рисуем через SVG <text>. SVG и Canvas
    // используют немного разные метрики шрифта, из-за чего визуальная граница букв
    // могла уезжать относительно размерных линий: текст поднимался, смещался вправо,
    // а логотип визуально оказывался ниже. Теперь каждая строка растрируется тем же
    // Canvas API, которым измеряется её геометрия, и ставится строго по тем же координатам.
    const hasCurvedText = curveAmounts.some(value => Math.abs(value || 0) > 0.001);
    const useTechnicalRasterText = pdfMode && drawingMode && !hasCurvedText;
    const technicalTextLines = lines.map((line, i) => {
      ...
      const lineLeft = textStartX + (lineOffsetsScaled[i] || 0);
      const scaledAscent = (metric.ascent || lineFontSizesPx[i] * 0.72) * scale;
      const scaledDescent = (metric.descent || 0) * scale;
      const actualGlyphHeight = Math.max(1, scaledAscent + scaledDescent);
      const strokeBase = Math.max(0.7, (fontSizes[i] || fontSize) * 0.014);
      const pad = Math.ceil(Math.max(20, depthPx * 3 + 10, strokeBase * 4, scaledDescent + 8));
      const rasterWidth = Math.max(1, Math.ceil((lineWidthsScaled[i] || 1) + depthPx + strokeBase * 4 + pad * 2));
      const rasterHeight = Math.max(1, Math.ceil(actualGlyphHeight + depthPx + strokeBase * 4 + pad * 2));
      const rasterSupersample = pdfMode && drawingMode ? 3 : 1;
      let src = '';

      if (typeof document !== 'undefined') {
        const canvas = document.createElement('canvas');
        canvas.width = Math.max(1, Math.round(rasterWidth * rasterSupersample));
        canvas.height = Math.max(1, Math.round(rasterHeight * rasterSupersample));
        const ctx = canvas.getContext('2d');
        if (ctx) {
          const familyValue = lineFonts[i] || font;
          const family = fontCssFamily(familyValue);
          const weight = fontCssWeight(familyValue);
          const size = fontSizes[i] || fontSize;
          ctx.scale(rasterSupersample, rasterSupersample);
          const faceColor = lineFaces[i] || face;
          const sideColor = lineSides[i] || side;
          const metricLeft = (metric.left || 0) * scale;
          const baselineX = pad + metricLeft;
          const baselineY = pad + scaledAscent;
          ...
          if (depthPx > 0.1) {
            ...
            ctx.lineWidth = Math.max(strokeBase, depthPx * 0.35);
            ctx.strokeText(line, baselineX + depthPx, baselineY + depthPx);
            ctx.fillText(line, baselineX + depthPx, baselineY + depthPx);
          }
          ...
          ctx.strokeStyle = sideColor;
          ctx.lineWidth = strokeBase;
          ctx.strokeText(line, baselineX, baselineY);
          ctx.fillText(line, baselineX, baselineY);
    ...
    return <div
      ...
      onTouchStart={pdfMode ? undefined : startSignTouch}
    >
      {!pdfMode && <button className="rotateHandle" style={{ top: heightPx + 78, left: widthPx + 86, transform: 'none' }} title="Зажмите и поверните вывеску" onMouseDown={(e) => {
        ...
        if (!e.touches.length || !stageRef.current) return;
        e.stopPropagation();
        const t = e.touches[0];
        const p = getStagePoint(t.clientX, t.clientY);
        const cx = signPos.x + visualSignWidthPx / 2;
      ...
      <div className="letters" style={lettersStyle} data-lighting={lighting} ref={!pdfMode && !drawingMode ? liveLettersRef : undefined}>
        ...
        {useTechnicalRasterText
          ? <div className="technicalRasterTextLayer" aria-hidden="true">
              {technicalTextLines.map((item, i) => item.src ? <img
                key={`technical-line-${i}`}
                className="technicalRasterTextLine"
                src={item.src}
                alt=""
                draggable={false}
          ...
          : <div className="curvedTextBlock" style={{ left: textStartX, top: textTopY, width: textWidthPxScaled, height: textBlockHeightPx }}>
              {lines.map((line, i) => {
                const layout = curvedLineLayouts[i];
                const lineTop = i === 0 ? 0 : (lineHeightsScaled[0] || 0) + lineGapPxScaled;
                return <div key={`curve-line-${i}`} className="curvedTextLine" style={{
                  left: lineOffsetsScaled[i] || 0,
                  top: lineTop,
                  width: (layout?.width || 1) * scale,
                  height: (layout?.height || lineTargetHeightsPx[i]) * scale
                }}>
                  {(layout?.glyphs || []).map((glyph, glyphIndex) => <span key={`${i}-${glyphIndex}-${glyph.char}`} className="curvedGlyph" style={{
                    left: (glyph.x - glyph.width / 2) * scale,
                    top: (glyph.yOffset - (layout?.minY || 0)) * scale,
                    width: glyph.width * scale,
                    height: lineTargetHeightsPx[i] * scale,
                    fontSize: fontSizes[i],
                    fontFamily: fontCssFamily(lineFonts[i] || font),
                    fontWeight: fontCssWeight(lineFonts[i] || font),
                    lineHeight: `${lineTargetHeightsPx[i] * scale}px`,
                    transform: `rotate(${glyph.rotation}deg)`,
                    transformOrigin: '50% 50%',
                    ...lightingTextStyle(fontSizes[i], lineFaces[i] || face, lineSides[i] || side)
  ...
  return <>
    <main className="app constructorFrame">
      <aside className="panel left panelPremium">
        ...
        <label>Реальный размер между точками, мм<input
          type="number"
          min="1"
          value={calibrationInput}
          onChange={e => setCalibrationInput(e.target.value)}
          onBlur={commitCalibrationInput}
          onKeyDown={e => {
            if (e.key === 'Enter') {
        ...
        <label className="curveControl">Изгиб первой строки <span>{curve1 > 0 ? `вверх ${curve1}%` : curve1 < 0 ? `вниз ${Math.abs(curve1)}%` : 'прямая'}</span><input type="range" min="-100" max="100" step="1" value={curve1} onChange={e => setCurve1(Number(e.target.value))} /></label>
        <label className="check"><input type="checkbox" checked={followCurve1} onChange={e => setFollowCurve1(e.target.checked)} /> Поворачивать буквы по дуге</label>
        ...
        {twoLines && <label className="curveControl">Изгиб второй строки <span>{curve2 > 0 ? `вверх ${curve2}%` : curve2 < 0 ? `вниз ${Math.abs(curve2)}%` : 'прямая'}</span><input type="range" min="-100" max="100" step="1" value={curve2} onChange={e => setCurve2(Number(e.target.value))} /></label>}
        {twoLines && <label className="check"><input type="checkbox" checked={followCurve2} onChange={e => setFollowCurve2(e.target.checked)} /> Поворачивать буквы второй строки по дуге</label>}
        ...
        <div className="exportButtonsRow">
          <button className="panelPdfButton premiumPdfButton" onClick={() => requestDownload('pdf')}>Скачать PDF</button>
          <button className="panelPdfButton panelSvgButton" onClick={() => requestDownload('svg')}>Скачать SVG</button>
        </div>
      </aside>
      ...
      <section className="workspace">
        <div className={'stage ' + (night ? 'night' : '') + (facadeDragOver ? ' facadeDragOver' : '')} ref={stageRef} onClick={clickStage} onDragOver={onStageDragOver} onDragLeave={onStageDragLeave} onDrop={onStageDrop}>
          ...
          {points.map((p, i) => <div key={i} className="point" style={{ left: p.x, top: p.y }} onMouseDown={(e) => startPointDrag(e, i)} onTouchStart={(e) => startPointTouch(e, i)} />)}
          <CalibrationLine />
          {facade && <SignGraphic />}
        </div>
      </section>
    ...
    {downloadGateOpen && createPortal(
      <div className="leadGateOverlay" role="dialog" aria-modal="true" aria-labelledby="lead-gate-title" onMouseDown={(e) => {
        if (e.target === e.currentTarget && !leadSending) setDownloadGateOpen(false);
      }}>
        <div className="leadGateModal">
          <h3 id="lead-gate-title">Укажите контакты для скачивания</h3>
          <p>Введите имя и телефон. После успешной отправки данных файл {pendingDownload === 'svg' ? 'SVG' : 'PDF'} начнёт скачиваться автоматически.</p>
          <form onSubmit={submitLeadForDownload}>
            <label>Ваше имя
              <input type="text" autoComplete="name" value={leadName} onChange={(e) => setLeadName(e.target.value)} placeholder="Иван" disabled={leadSending} />
            </label>
            <label>Телефон для связи
              <input type="tel" autoComplete="tel" inputMode="tel" value={leadPhone} onChange={(e) => setLeadPhone(e.target.value)} placeholder="+7 999 123-45-67" disabled={leadSending} />
            </label>
            {leadError && <div className="leadGateError" role="alert">{leadError}</div>}
            <button type="submit" className="leadGateSubmit" disabled={leadSending}>
              {leadSending ? 'Отправляем данные…' : 'Скачать макет'}
            </button>
          </form>
          <small className="leadGateConsent">Нажимая кнопку «Скачать макет», я даю свое согласие на обработку моих персональных данных, в соответствии с Федеральным законом от 27.07.2006 года №152-ФЗ «О персональных данных», на условиях и для целей, определенных в Согласии на обработку персональных данных.</small>
        </div>
      </div>,
      document.body
    )}
          ...
          <div className="pdfFacadeStage snapshotStage">
            {stageShotDay ? <>
              <div className="stageSnapshotBox stageSnapshotBoxFixed" style={stageShotBoxStyle}>
                <img src={stageShotDay} className="stageSnapshot"/>
              </div>
