        ...
        <div className="pdfDrawingGrid centeredLayout">
          ...
          <aside className="pdfSpec pdfSpecHorizontal">
            <div className="pdfSpecItem">
              ...
              {twoLines && <span><strong>Данные второй строки:</strong>{fontDisplayName(line2Font)}</span>}
            </div>
            <div className="pdfSpecItem">
              ...
              {twoLines && <span><i style={{background: line2Face}}></i><strong>Данные второй строки:</strong>{colorName(ORACAL_8500, line2Face)}</span>}
            </div>
            <div className="pdfSpecItem">
              ...
              {twoLines && <span><i style={{background: line2Side}}></i><strong>Данные второй строки:</strong>{colorName(ORACAL_641, line2Side)}</span>}
            </div>
          </aside>
        </div>
