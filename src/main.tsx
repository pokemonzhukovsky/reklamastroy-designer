    ...
    >
      ...
      >
        ...
        {drawingMode && pdfMode ? <>
          ...
          {drawVDim('sign-height', signHeightDimX, signAbsTop, signAbsBottom, substrateEnabled ? signAbsRight : signAbsLeft, mm(contentHeightMm), substrateEnabled ? 'right' : 'left', { textOffset: 18 })}
          {logo && <>
          ...
          {lineAbs[0] && drawVDim('line1-cap-height', line1CapX, lineAbs[0].top, lineAbs[0].bottom, lineAbs[0].right, mm(line1HeightCm), 'right', { horizontalLabel: true, labelY: lineAbs[0].top + 18, textOffset: 9 })}
          {lineAbs[0]?.hasLower && drawVDim('line1-lower-height', line1LowerX, lineAbs[0].bottom - lineAbs[0].lowerHeight, lineAbs[0].bottom, lineAbs[0].right, mm(lineAbs[0].lowerMm), 'right', { horizontalLabel: true, labelY: lowerLabelY(lineAbs[0]), textOffset: 9 })}
          {twoLines && lines[1]?.trim() && lineAbs[1] && <>
            ...
            {drawVDim('line2-cap-height', line2CapX, lineAbs[1].top, lineAbs[1].bottom, lineAbs[1].right, mm(line2HeightMm), 'right', { horizontalLabel: true, labelY: lineAbs[1].top + 18, textOffset: 9 })}
            {lineAbs[1].hasLower && drawVDim('line2-lower-height', line2LowerX, lineAbs[1].bottom - lineAbs[1].lowerHeight, lineAbs[1].bottom, lineAbs[1].right, mm(lineAbs[1].lowerMm), 'right', { horizontalLabel: true, labelY: lowerLabelY(lineAbs[1]), textOffset: 9 })}
          </>}
        </> : <>
          ...
          {drawVDim('live-sign-height', substrateEnabled ? substrateAbsRight + 22 : signAbsLeft - 22, signAbsTop, signAbsBottom, substrateEnabled ? signAbsRight : signAbsLeft, mm(contentHeightMm), substrateEnabled ? 'right' : 'left')}
        </>}
      </svg>
