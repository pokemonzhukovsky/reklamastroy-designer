...
function App() {
  ...
  return <>
    <header className="topbar">
      <div className="brand"><b>РЕКЛАМА<span>СТРОЙ</span></b><small>Производство рекламных конструкций</small></div>
      <h1>Онлайн примерка вывески с привязкой к фасаду здания</h1>
      <button onClick={pdf}>Скачать PDF</button>
    </header>
    ...
    <main className="app">
      ...
      <aside className="panel right">
        <div className="modernCard"><b>Онлайн примерка вывески</b><span>Загрузите фасад → задайте масштаб → настройте объёмные буквы → скачайте PDF.</span></div>
